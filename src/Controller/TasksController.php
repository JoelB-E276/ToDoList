...
class TasksController extends AbstractController
{
    ...
    //Créer un tâche ## En cours
    #[Route('/tasks{id}', name: 'task_new', methods: ['GET', 'POST'])]
    public function newTask(ProjectRepository $projectRepository, Request $request, Task $task, int $id): Response
    {
        $form = $this->createForm(TaskType::class, $task);
        $form->handleRequest($request);
